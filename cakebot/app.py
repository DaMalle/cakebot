...
import os, sys, math, random, asyncio, functools, itertools, datetime
...
class Music(commands.Cog):
    ...
    async def _skip(self, ctx: commands.Context):
        ...
        else: await ctx.send('You have already voted to skip this song.')
...
@bot.event
async def on_ready():
    lprint('Logged in: {0.user.name} - {0.user.id}'.format(bot))
